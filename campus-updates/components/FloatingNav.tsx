...
const FloatingNav = ({ items }: { items?: Item[] }) => {
	...
	return (
		<div className="lg:hidden fixed bottom-6 left-1/2 -translate-x-1/2 z-50 w-full max-w-xs sm:max-w-sm">
			<div className="relative flex items-center justify-between gap-1 rounded-full px-2 py-2 shadow-2xl border backdrop-blur-xl bg-card/80 border-border">
				{/* Active Indicator Glow */}
				<motion.div
					layoutId="active-indicator"
					className="absolute w-12 h-12 rounded-full blur-2xl -z-10 bg-primary/60"
					animate={{
