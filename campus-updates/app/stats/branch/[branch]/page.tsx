					...
					<div className="mb-8">
						...
						<div className="grid grid-cols-2 sm:grid-cols-2 lg:grid-cols-4 gap-3 sm:gap-4 mb-8">
							{[...Array(4)].map((_, i) => (
								<div
									key={i}
									className="border rounded-xl p-5 card-theme bg-card border-border h-32 flex flex-col justify-between"
								>
						...
						<div className="mb-8">
							...
							<div className="grid grid-cols-1 md:grid-cols-2 xl:grid-cols-3 gap-4">
								{[...Array(3)].map((_, i) => (
									<div
										key={i}
										className="border rounded-xl p-5 card-theme bg-card/60 border-border h-40"
									>
